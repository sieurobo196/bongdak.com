...
<html>
<head>
<title>Live info a Sports Category Flat Bootstrap Responsive Website Template | More :: w3layouts</title>
			...
			<div class="left-side-inner">
				...
				<!--sidebar nav start-->
					<ul class="nav nav-pills nav-stacked custom-nav">
						...
						<li class="active"><a href="more.html"><img src="images/17.png" alt="" /><span>More</span></a></li> 
					</ul>
				<!--sidebar nav end-->
				</div>
			</div>
						...
						<div class="col-md-9 top-grid-left basket-top-grid-left">
								...
								<div class="col-md-8 top-grid-left-left">
									<div class="top-grid-left-left-grids">
										<div class="col-md-8 top-grid-left-img">
											<div data-video="4--iEOftLZ4" id="video"> 
												<img src="images/ice1.jpg" alt="Use your own screenshot."> 
											</div>
										</div>
									...
									<div class="three-grids">
										<div class="three-grid">
											<div class="three-grid-info">
												<div class="three-grid-img">
													<a href="single.html"><img src="images/ice2.jpg" alt="" /></a>
												</div>
										...
										<div class="three-grid">
											<div class="three-grid-info">
												<div class="three-grid-img">
													<a href="single.html"><img src="images/ice3.jpg" alt="" /></a>
												</div>
												<div class="three-grid-text">
													<div class="three-grid-text-heading">
														<a class="text" href="single.html">Fusce ornare congue ligula vel placerat</a>
										...
										<div class="three-grid">
											<div class="three-grid-info">
												<div class="three-grid-img">
													<a href="single.html"><img src="images/ice4.jpg" alt="" /></a> 
												</div>
												<div class="three-grid-text">
													<div class="three-grid-text-heading">
														<a class="text" href="single.html">Fusce ornare congue ligula vel placerat</a>
									...
									<div class="two-grids">
										<div class="col-md-6 two-grid-left">
											<div class="two-grid-info">
												<div class="two-grid-img">
													<a href="single.html"><img src="images/volleyball1.jpg" alt="" /></a>
												</div>
										...
										<div class="col-md-6 two-grid-right">
											<div class="two-grid-info">
												<div class="two-grid-img">
													<a href="single.html"><img src="images/volleyball2.jpg" alt="" /></a>
												</div>
												<div class="two-grid-text">
													<div class="three-grid-text-heading two-grid-text-heading">
										...
										<div class="two-grids-bottom-grids">
											<div class="col-md-6 two-grids-bottom-grid">
												<div class="two-grids-bottom-grid-img">
													...
													<a href="single.html"><img src="images/volleyball3.jpg" alt="" /></a>
												</div>
											...
											<div class="col-md-6 two-grids-bottom-grid">
												<div class="two-grids-bottom-grid-img">
													...
													<a href="single.html"><img src="images/volleyball4.jpg" alt="" /></a>
												</div>
												<div class="two-grids-bottom-grid-info">
													<ul>
														<li><a href="single.html"><i class="fa fa-arrow-right"></i> Mauris ac vestibulum lectus</a></li>
										...
										<div class="two-grids-bottom-grids">
											<div class="col-md-6 two-grids-bottom-grid">
												<div class="two-grids-bottom-grid-img">
													...
													<a href="single.html"><img src="images/volleyball5.jpg" alt="" /></a>
												</div>
												<div class="two-grids-bottom-grid-info">
													<ul>
														<li><a href="single.html"><i class="fa fa-arrow-right"></i> Mauris ac vestibulum lectus</a></li>
											...
											<div class="col-md-6 two-grids-bottom-grid">
												<div class="two-grids-bottom-grid-img">
													...
													<a href="single.html"><img src="images/volleyball6.jpg" alt="" /></a>
												</div>
												<div class="two-grids-bottom-grid-info">
													<ul>
														<li><a href="single.html"><i class="fa fa-arrow-right"></i> Mauris ac vestibulum lectus</a></li>
											...
											<div class="col-md-6 more-news-left">
												...
												<div class="news-right-grids">
													<div class="news-right-grids-img">
														<a href="single.html"><img src="images/cycle1.jpg" alt="" /></a>
													</div>
												...
												<div class="news-right-grids">
													<div class="news-right-grids-img">
														<a href="single.html"><img src="images/cycle2.jpg" alt="" /></a>
													</div>
													<div class="news-right-grids-info">
												...
												<div class="news-right-grids">
													<div class="news-right-grids-img">
														<a href="single.html"><img src="images/cycle3.jpg" alt="" /></a>
													</div>
													<div class="news-right-grids-info">
												...
												<div class="news-right-grids">
													<div class="news-right-grids-img">
														<a href="single.html"><img src="images/cycle4.jpg" alt="" /></a>
													</div>
													<div class="news-right-grids-info">
												...
												<div class="news-right-grids">
													<div class="news-right-grids-img">
														<a href="single.html"><img src="images/cycle5.jpg" alt="" /></a>
													</div>
													<div class="news-right-grids-info">
												...
												<div class="news-right-grids a-right-grids">
													<div class="news-right-grids-img">
														<a href="single.html"><img src="images/cycle6.jpg" alt="" /></a>
													</div>
													<div class="news-right-grids-info">
							...
							<!-- //most-view-grids -->
									<div class="top-grid-left-right-grid">
										<div class="top-grid-left-right-img">
											<a href="single.html"><img src="images/kayaking1.jpg" alt="" /></a>
										</div>
										<div class="top-grid-left-right-info">
									...
									<div class="top-grid-left-right-grid">
										...
										<div class="top-grid-left-right-img">
											<a href="single.html"><img src="images/kayaking2.jpg" alt="" /></a>
										</div>
										<div class="top-grid-left-right-info">
											<a class="text" href="single.html">Lorem ipsum dolor sit amet</a>
											<p>Nam id sollicitudin felis. Nulla non bibendum arcu.Suspendisse venenatis venenatis mi, et cursus risus vehicula non.</p>
									...
									<div class="top-grid-left-right-grid">
										...
										<div class="top-grid-left-right-img">
											<a href="single.html"><img src="images/kayaking3.jpg" alt="" /></a>
										</div>
										<div class="top-grid-left-right-info">
											<a class="text" href="single.html">Donec sodales consectetur ex, in euismod odio pharetra eget</a>
											<p>Nam id sollicitudin felis. Nulla non bibendum arcu.Suspendisse venenatis venenatis mi, et cursus risus vehicula non.</p>
									...
									<div class="top-grid-left-right-grid">
										...
										<div class="top-grid-left-right-img">
											<a href="single.html"><img src="images/kayaking4.jpg" alt="" /></a>
										</div>
										<div class="top-grid-left-right-info">
											<a class="text" href="single.html">Donec sodales consectetur ex, in euismod odio pharetra eget</a>
											<p>Nam id sollicitudin felis. Nulla non bibendum arcu.Suspendisse venenatis venenatis mi, et cursus risus vehicula non.</p>
