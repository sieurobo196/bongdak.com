...
<html>
<head>
<title>Live info a Sports Category Flat Bootstrap Responsive Website Template | Tennis :: w3layouts</title>
			...
			<div class="left-side-inner">
				...
				<!--sidebar nav start-->
					<ul class="nav nav-pills nav-stacked custom-nav">
						...
						<li class="active"><a href="tennis.html"><img src="images/14.png" alt="" /><span>Tennis</span></a></li> 
								...
								<div class="col-md-8 top-grid-left-left">
									<div class="top-grid-left-left-grids">
										<div class="col-md-8 top-grid-left-img">
											<div data-video="kV5md9zHVy4" id="video"> 
												<img src="images/t3.jpg" alt="Use your own screenshot."> 
											</div>
										</div>
