...
<html>
<head>
<title>Live info a Sports Category Flat Bootstrap Responsive Website Template | Club :: w3layouts</title>
			...
			<div class="left-side-inner">
				...
				<!--sidebar nav start-->
					<ul class="nav nav-pills nav-stacked custom-nav">
						<li class="active"><a href="index.html"><img src="images/9.png" alt="" /><span>Football</span></a></li> 
						...
						<div class="col-md-8 club-left">
							...
							<div class="club-news">
								<div class="news-heading">
									<h3>Barcelona News</h3>
								</div>
								<div class="news-bottom-grids">
									<div class="col-md-6 news-bottom">
										<ul>
											<li><a href="single.html"><i class="fa fa-arrow-right"></i> Lorem ipsum dolor sit amet, consectetur adipiscing elit.</a></li>
											<li><a href="single.html"><i class="fa fa-arrow-right"></i> Vivamus at orci lorem. In ac justo urna.</a></li>
											<li><a href="single.html"><i class="fa fa-arrow-right"></i> Cras luctus, urna quis posuere dictum, purus erat</a></li>
											<li><a href="single.html"><i class="fa fa-arrow-right"></i> Suspendisse ultrices vehicula sem ac placerat.</a></li>
											<li><a href="single.html"><i class="fa fa-arrow-right"></i> Fusce molestie sapien at risus dictum accumsan.</a></li>
											<li><a href="single.html"><i class="fa fa-arrow-right"></i> Sed hendrerit, dolor in tincidunt malesuada, lacus mi malesuada lectus</a></li>
										</ul>
									</div>
									<div class="col-md-6 news-bottom">
										<ul>
