...
<html>
<head>
<title>Live info a Sports Category Flat Bootstrap Responsive Website Template | Motor :: w3layouts</title>
			...
			<div class="left-side-inner">
				...
				<!--sidebar nav start-->
					<ul class="nav nav-pills nav-stacked custom-nav">
						...
						<li class="active"><a href="motor.html"><img src="images/10.png" alt="" /><span>Motor Sports</span></a></li> 
				...
				<div class="top-grids">
					<div class="top-grids-info">
							...
							<div class="top-big-grids">
								<div class="col-md-8 top-grid-left-left">
									<div class="top-grid-left-left-grids">
										<div class="col-md-8 top-grid-left-img boxing-iframe">
											<iframe src="https://www.youtube.com/embed/Mg52AUQd5KY" frameborder="0" allowfullscreen></iframe>
										</div>
									...
									<div class="three-grids">
										<div class="three-grid">
											<div class="three-grid-info">
												<div class="three-grid-img">
													<a href="single.html"><img src="images/motor1.jpg" alt="" /></a>
												</div>
										...
										<div class="three-grid">
											<div class="three-grid-info">
												<div class="three-grid-img">
													<a href="single.html"><img src="images/motor2.jpg" alt="" /></a>
												</div>
												<div class="three-grid-text">
													<div class="three-grid-text-heading">
														<a class="text" href="single.html">Fusce ornare congue ligula vel placerat</a>
										...
										<div class="three-grid">
											<div class="three-grid-info">
												<div class="three-grid-img">
													<a href="single.html"><img src="images/motor3.jpg" alt="" /></a> 
												</div>
												<div class="three-grid-text">
													<div class="three-grid-text-heading">
														<a class="text" href="single.html">Fusce ornare congue ligula vel placerat</a>
									...
									<div class="two-grids">
										<div class="col-md-6 two-grid-left">
											<div class="two-grid-info motor-two-grid-info">
												<div class="two-grid-img">
													<iframe src="https://www.youtube.com/embed/YqYPU3MNqHw" frameborder="0" allowfullscreen></iframe>
												</div>
										...
										<div class="col-md-6 two-grid-right">
											<div class="two-grid-info motor-two-grid-info">
												<div class="two-grid-img">
													<iframe src="https://www.youtube.com/embed/7ZUybiDSzSI" frameborder="0" allowfullscreen></iframe>
												</div>
												<div class="two-grid-text">
													<div class="three-grid-text-heading two-grid-text-heading">
										...
										<div class="two-grids-bottom-grids">
											<div class="col-md-6 two-grids-bottom-grid">
												<div class="two-grids-bottom-grid-img">
													...
													<a href="single.html"><img src="images/motor6.jpg" alt="" /></a>
												</div>
											...
											<div class="col-md-6 two-grids-bottom-grid">
												<div class="two-grids-bottom-grid-img">
													...
													<a href="single.html"><img src="images/motor7.jpg" alt="" /></a>
												</div>
												<div class="two-grids-bottom-grid-info">
													<ul>
														<li><a href="single.html"><i class="fa fa-arrow-right"></i> Mauris ac vestibulum lectus</a></li>
										...
										<div class="two-grids-bottom-grids">
											<div class="col-md-6 two-grids-bottom-grid">
												<div class="two-grids-bottom-grid-img">
													...
													<a href="single.html"><img src="images/motor8.jpg" alt="" /></a>
												</div>
												<div class="two-grids-bottom-grid-info">
													<ul>
														<li><a href="single.html"><i class="fa fa-arrow-right"></i> Mauris ac vestibulum lectus</a></li>
											...
											<div class="col-md-6 two-grids-bottom-grid">
												<div class="two-grids-bottom-grid-img">
													...
													<a href="single.html"><img src="images/motor9.jpg" alt="" /></a>
												</div>
												<div class="two-grids-bottom-grid-info">
													<ul>
														<li><a href="single.html"><i class="fa fa-arrow-right"></i> Mauris ac vestibulum lectus</a></li>
											...
											<div class="col-md-6 more-news-left">
												...
												<div class="news-right-grids">
													<div class="news-right-grids-img">
														<a href="single.html"><img src="images/motor10.jpg" alt="" /></a>
													</div>
												...
												<div class="news-right-grids">
													<div class="news-right-grids-img">
														<a href="single.html"><img src="images/motor11.jpg" alt="" /></a>
													</div>
													<div class="news-right-grids-info">
												...
												<div class="news-right-grids">
													<div class="news-right-grids-img">
														<a href="single.html"><img src="images/motor12.jpg" alt="" /></a>
													</div>
													<div class="news-right-grids-info">
								...
								<div class="col-md-4 top-grid-left-right">
									...
									<div class="top-grid-left-right-grid">
										...
										<div class="top-grid-left-right-img">
											<a href="single.html"><img src="images/motor4.jpg" alt="" /></a>
										</div>
										<div class="top-grid-left-right-info">
									...
									<div class="top-grid-left-right-grid">
										...
										<div class="top-grid-left-right-img">
											<a href="single.html"><img src="images/motor5.jpg" alt="" /></a>
										</div>
										<div class="top-grid-left-right-info">
									...
									<div class="top-news">
										...
										<div class="top-news-grids">
											...
											<div class="top-news-grid box-top-news-grid">
												<div class="top-news-grid-heading">
											...
											<div class="top-news-grid box-top-news-grid2">
												<div class="top-news-grid-heading">
													<a href="single.html">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean rutrum ac nulla</a>
												</div>
												<div class="t-grid m-t-grid">
						...
						<div class="col-md-3 top-grid-right">
							<!-- latest -->
							<div class="today-match latest boxing-latest">
									...
									<div id="horizontalTab" style="display: block; margin: 0px;">
										...
										<div class="resp-tabs-container">
											...
											<div class="tab-1 resp-tab-content" aria-labelledby="tab_item-1">
												...
												<div class="news-right-grids most-view-left">
													<div class="news-right-grids-img most-view-left-img">
														<a href="single.html"><img src="images/motor13.jpg" alt=""></a>
													</div>
													<div class="news-right-grids-info most-view-left-img">
														<a href="single.html">Duis accumsan</a>
														<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
