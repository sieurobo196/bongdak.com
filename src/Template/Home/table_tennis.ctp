...
<html>
<head>
<title>Live info a Sports Category Flat Bootstrap Responsive Website Template | Table Tennis :: w3layouts</title>
			...
			<div class="left-side-inner">
				...
				<!--sidebar nav start-->
					<ul class="nav nav-pills nav-stacked custom-nav">
						...
						<li class="active"><a href="table_tennis.html"><img src="images/13.png" alt="" /><span>Table Tennis</span></a></li> 
								...
								<div class="col-md-8 top-grid-left-left">
									<div class="top-grid-left-left-grids">
										<div class="col-md-8 top-grid-left-img boxing-iframe">
											<iframe src="https://www.youtube.com/embed/E6xZ4maYsc4" frameborder="0" allowfullscreen></iframe>
										</div>
									...
									<div class="three-grids">
										<div class="three-grid">
											<div class="three-grid-info">
												<div class="three-grid-img">
													<a href="single.html"><img src="images/table1.jpg" alt="" /></a>
												</div>
										...
										<div class="three-grid">
											<div class="three-grid-info">
												<div class="three-grid-img">
													<a href="single.html"><img src="images/table2.jpg" alt="" /></a>
												</div>
												<div class="three-grid-text">
													<div class="three-grid-text-heading">
														<a class="text" href="single.html">Fusce ornare congue ligula vel placerat</a>
										...
										<div class="three-grid">
											<div class="three-grid-info">
												<div class="three-grid-img">
													<a href="single.html"><img src="images/table3.jpg" alt="" /></a> 
												</div>
												<div class="three-grid-text">
													<div class="three-grid-text-heading">
														<a class="text" href="single.html">Fusce ornare congue ligula vel placerat</a>
									...
									<div class="two-grids">
										<div class="col-md-6 two-grid-left">
											<div class="two-grid-info motor-two-grid-info">
												<div class="two-grid-img">
													<iframe src="https://www.youtube.com/embed/bcudCvg7CL8" frameborder="0" allowfullscreen></iframe>
												</div>
										...
										<div class="col-md-6 two-grid-right">
											<div class="two-grid-info motor-two-grid-info">
												<div class="two-grid-img">
													<iframe src="https://www.youtube.com/embed/dTl7UCda80o" frameborder="0" allowfullscreen></iframe>
												</div>
												<div class="two-grid-text">
													<div class="three-grid-text-heading two-grid-text-heading">
										...
										<div class="two-grids-bottom-grids">
											<div class="col-md-6 two-grids-bottom-grid">
												<div class="two-grids-bottom-grid-img">
													...
													<a href="single.html"><img src="images/table6.jpg" alt="" /></a>
												</div>
											...
											<div class="col-md-6 two-grids-bottom-grid">
												<div class="two-grids-bottom-grid-img">
													...
													<a href="single.html"><img src="images/table7.jpg" alt="" /></a>
												</div>
												<div class="two-grids-bottom-grid-info">
													<ul>
														<li><a href="single.html"><i class="fa fa-arrow-right"></i> Mauris ac vestibulum lectus</a></li>
										...
										<div class="two-grids-bottom-grids">
											<div class="col-md-6 two-grids-bottom-grid">
												<div class="two-grids-bottom-grid-img">
													...
													<a href="single.html"><img src="images/table8.jpg" alt="" /></a>
												</div>
												<div class="two-grids-bottom-grid-info">
													<ul>
														<li><a href="single.html"><i class="fa fa-arrow-right"></i> Mauris ac vestibulum lectus</a></li>
											...
											<div class="col-md-6 two-grids-bottom-grid">
												<div class="two-grids-bottom-grid-img">
													...
													<a href="single.html"><img src="images/table9.jpg" alt="" /></a>
												</div>
												<div class="two-grids-bottom-grid-info">
													<ul>
														<li><a href="single.html"><i class="fa fa-arrow-right"></i> Mauris ac vestibulum lectus</a></li>
									...
									<div class="more-news">
										...
										<div class="more-news-grids">
											...
											<div class="col-md-6 more-news-left">
												...
												<div class="news-right-grids">
													<div class="news-right-grids-img">
														<a href="single.html"><img src="images/table4.jpg" alt="" /></a>
													</div>
													<div class="news-right-grids-info">
												...
												<div class="news-right-grids">
													<div class="news-right-grids-img">
														<a href="single.html"><img src="images/table5.jpg" alt="" /></a>
													</div>
													<div class="news-right-grids-info">
