    ...
    <div class="left-side-inner">
        <div class="scrollbar scrollbar1">
            ...
            <ul class="nav nav-pills nav-stacked custom-nav">
                <!--<li class="<?php echo $activeMenu == 'world-cup' ? 'active' : '';?>"><a href="<?php echo $this->Url->build(["controller" => "articles", "action" => "single","world-cup"]); ?>"><img src="<?php echo $this->request->webroot . "img/" ?>images/logo/World_Cup_2018_Logo.png" alt="" class="images_menu"/><span>World Cup 2018 </span></a></li>--> 
                ...
                <li class="<?php echo $activeMenu == 'khac' ? 'active' : '';?>"><a href="<?php echo $this->Url->build(["controller" => "articles", "action" => "single","khac"]); ?>"><img src="<?php echo $this->request->webroot . "img/" ?>images/logo/bongda.jpg" alt="" class="images_menu" /><span>Khác</span></a></li>
